...
import { Settings, LogOut, Twitter, Linkedin, Loader2, Check, Trash2, AlertCircle, ExternalLink } from 'lucide-react';
                ...
                >
                  ...
                  {connected ? (
                    ...
                    <button
                      ...
                      className="ml-4 px-4 py-2 text-sm font-medium bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-colors flex items-center gap-2 flex-shrink-0"
                    >
                      {isConnecting ? (
                        <>
