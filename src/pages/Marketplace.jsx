            ...
            {displayProducts.map((product, index) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {product.seller_name && (
                    <button onClick={(e) => { e.stopPropagation(); setSelectedProduct(null); setSelectedSeller(product.seller_name); setActiveCategory('all'); setSearchQuery(''); }} className="text-xs text-indigo-400 hover:text-indigo-300 transition-colors mb-2 block">by {product.seller_name}</button>
                  )}
